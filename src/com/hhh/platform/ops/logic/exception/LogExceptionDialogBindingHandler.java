...
public class LogExceptionDialogBindingHandler extends DefaultBindingHandler {
	private static Log log = LogFactory.getLog(LogExceptionDialogBindingHandler.class);
	...
	public LogExceptionDialogBindingHandler(String operationId, LogExceptionEntity entity) {
	...
	public boolean initControls() {
		try {
			...
			String sql = "com.hhh.platform.ops.sql.ops_log_exceptionMapper.selectLog";
