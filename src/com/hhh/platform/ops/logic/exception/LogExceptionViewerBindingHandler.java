...
public class LogExceptionViewerBindingHandler extends EntityViewerBindingHandler {

	private PagingPartionUtil pagingPartionUtil;

	private LogExceptionViewerCreator controlsCreator;
	...
	private void initPagePart() {
		this.controlsCreator = (LogExceptionViewerCreator) controlsCreators.get(LogExceptionViewerCreator.class
				.getName());
		pagingPartionUtil = new PagingPartionUtil(this.controlsCreator.getViewer(),
				...
				"com.hhh.platform.ops.sql.ops_log_exceptionMapper.countAllLog",
				"com.hhh.platform.ops.sql.ops_log_exceptionMapper.selectAllLog",
	...
	public LogExceptionViewerCreator getControlsCreator() {
