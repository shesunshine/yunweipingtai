...
public class LogRunViewerBindingHandler extends EntityViewerBindingHandler {

	private PagingPartionUtil pagingPartionUtil;

	private LogRunViewerCreator controlsCreator;
	...
	private void initPagePart() {
		this.controlsCreator = (LogRunViewerCreator) controlsCreators.get(LogRunViewerCreator.class.getName());
		pagingPartionUtil = new PagingPartionUtil(this.controlsCreator.getViewer(),
				...
				"com.hhh.platform.ops.sql.ops_log_runMapper.countAllLog",
				"com.hhh.platform.ops.sql.ops_log_runMapper.selectAllLog",
	...
	public LogRunViewerCreator getControlsCreator() {
