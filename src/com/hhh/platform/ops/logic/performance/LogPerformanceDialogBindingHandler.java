...
public class LogPerformanceDialogBindingHandler extends DefaultBindingHandler {
	private static Log log = LogFactory.getLog(LogPerformanceDialogBindingHandler.class);
	...
	public LogPerformanceDialogBindingHandler(String operationId, LogPerformanceEntity entity) {
	...
	public boolean initControls() {
		try {
			...
			String sql = "com.hhh.platform.ops.sql.ops_log_performanceMapper.selectLog";
