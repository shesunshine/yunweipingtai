...
public class ServerRegisterViewerBindingHandler extends EntityViewerBindingHandler {

	private static Log log = LogFactory.getLog(ServerRegisterViewerBindingHandler.class);

	private PagingPartionUtil pagingPartionUtil;

	private ServerRegisterViewerCreator controlsCreator;
	...
	private void initPagePart() {
		this.controlsCreator = (ServerRegisterViewerCreator) controlsCreators.get(ServerRegisterViewerCreator.class.getName());
		pagingPartionUtil = new PagingPartionUtil(this.controlsCreator.getViewer(), this.controlsCreator.getPagePartitionArea(), FrameworkConstants.PAGE_SIZE,
				"com.hhh.platform.ops.sql.ops_server_registerMapper.countAllServer", "com.hhh.platform.ops.sql.ops_server_registerMapper.selectAllServer", (Button) this.allBindedControls.get("check_all"),
	...
	public ServerRegisterViewerCreator getControlsCreator() {
