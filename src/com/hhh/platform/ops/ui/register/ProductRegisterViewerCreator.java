...
public class ProductRegisterViewerCreator extends EntityWithTableViewerCreatorEditable {
	private String[] columnFieldNames = new String[0];
	
	public ProductRegisterViewerCreator(){
	...
	protected String[] getColumnFieldNames() {
		columnFieldNames = new String[] { "", "a.code", "a.name", "a.yw_type",
				"a.dm_type","a.version", "a.mark"};
		return columnFieldNames;

	}
	@Override
	protected String[] getColumnProperties() {
		String[] properties = new String[] { "", "产品编号", "产品名称", "业务类型","代码类型",
				"当前版本","备注"};
		return properties;
