...
public class LogExceptionViewerCreator extends EntityWithTableViewerCreatorEditable {
	private String[] columnFieldNames = new String[0];

	public LogExceptionViewerCreator() {
	...
	protected String[] getColumnFieldNames() {
		columnFieldNames = new String[] { "", "b.pd_code", "b.dp_code", "c.name", "b.dp_name", "a.write_date",
				"a.login_user","a.module","a.content" };
	...
	protected String[] getColumnProperties() {
		String[] properties = new String[] { "", "产品编号", "部署编号", "产品名称", "网站名", "记录日期","登录人","模块", "内容"};
		return properties;
	...
	protected void createSearchControl(Composite searchComposite, HashMap<String, Control> bindedControls) {
		...
		String modelFilePath = "com/hhh/platform/ops/ui/exception/LogExceptionViewSearcher.xml";
