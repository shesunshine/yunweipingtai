...
public class ServerSelectDialogCreator extends EntityWithTableViewerCreator {

	private String[] columnFieldNames = new String[0];

	public ServerSelectDialogCreator() {
	...
	protected String[] getColumnProperties() {
		String[] properties = new String[] { "","报警", "品牌型号", "产品类别", "操作系统", "CPU型号", "CPU频率(Hz)", "内存容量(GB)", "硬盘容量(GB)", "是否监控","存放位置", "供应商" };
		return properties;
