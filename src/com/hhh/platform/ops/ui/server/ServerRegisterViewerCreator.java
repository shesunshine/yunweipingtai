...
public class ServerRegisterViewerCreator extends EntityWithTableViewerCreatorEditable {
	private String[] columnFieldNames = new String[0];

	public ServerRegisterViewerCreator() {
	...
	public Set<String> getBindedFieldsNames() {
		...
		bindedFieldNames.add("a.add_user");
		return bindedFieldNames;
	}

	@Override
	protected String[] getColumnFieldNames() {
		columnFieldNames = new String[] { "", "a.server_model", "a.p_type", "a.os_type", "a.cpu_model", "a.cpu_hz", "a.ram_gb", "a.hdd_gb", "a.is_watch","a.site", "a.provider" };
	...
	protected String[] getColumnProperties() {
		String[] properties = new String[] { "", "品牌型号", "产品类别", "操作系统", "CPU型号", "CPU频率(Hz)", "内存容量(GB)", "硬盘容量(GB)", "是否监控","存放位置", "供应商" };
		return properties;
	...
	protected void createSearchControl(Composite searchComposite, HashMap<String, Control> bindedControls) {
		...
		String modelFilePath = "com/hhh/platform/ops/ui/server/ServerRegisterViewSearcher.xml";
