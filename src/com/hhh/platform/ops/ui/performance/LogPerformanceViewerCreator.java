...
public class LogPerformanceViewerCreator extends EntityWithTableViewerCreatorEditable {
	private String[] columnFieldNames = new String[0];

	public LogPerformanceViewerCreator() {
	...
	protected String[] getColumnFieldNames() {
		columnFieldNames = new String[] { "","alarm", "b.pd_code", "b.dp_code", "c.name", "b.dp_name", "a.write_date", "a.login_user", "a.module", "a.cost_time", "a.content" };
	...
	protected String[] getColumnProperties() {
		String[] properties = new String[] { "","报警", "产品编号", "部署编号", "产品名称", "网站名", "记录日期", "登录人", "模块", "消耗时间", "内容"};
		return properties;
	...
	protected void setColumnsWidth(String[] columnProperties) {
		for (int i = 0; i < columnProperties.length; i++) {
			...
			} else if (fieldName.equals("a.login_user")) {
				tableColumn.setWidth(100);
			} else if (fieldName.equals("a.module")) {
				tableColumn.setWidth(200);
			} else if (fieldName.equals("a.cost_time")) {
				tableColumn.setWidth(80);
			} else {
	...
	protected void createSearchControl(Composite searchComposite, HashMap<String, Control> bindedControls) {
		...
		String modelFilePath = "com/hhh/platform/ops/ui/performance/LogPerformanceViewSearcher.xml";
