...
public class LogExceptionView extends EntityViewPart {

	public static final String ID = "com.hhh.platform.ops.view.log.exception";

	private LogExceptionEntity currentEntity;
	...
	public void createPartControl2(Composite parent) {
		this.parent = parent;
		this.currentEntity = new LogExceptionEntity(TABLE_ROW_ID_KEY);
