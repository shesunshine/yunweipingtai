...
public class ProductDeployView extends EntityViewPart {

	public static final String ID = "com.hhh.platform.ops.view.product.deploy";

	private ProductDeployEntity currentEntity;

	public static String TABLE_ROW_ID_KEY = "a.dp_id";
	...
	public void createPartControl2(Composite parent) {
		this.parent = parent;
		this.currentEntity = new ProductDeployEntity(TABLE_ROW_ID_KEY);
