...
public class ServerRunView extends EntityViewPart {
	
	public static final String ID = "com.hhh.platform.ops.view.server.run";

	private ServerRunEntity currentEntity;
	...
	public void createPartControl2(Composite parent) {
		this.parent = parent;
		this.currentEntity = new ServerRunEntity(TABLE_ROW_ID_KEY);
