...
public class ServerRegisterView extends EntityViewPart {
	
	public static final String ID = "com.hhh.platform.ops.view.server.register";

	private ServerRegisterEntity currentEntity;

	public static String TABLE_ROW_ID_KEY = "a.server_id";
	...
	public void createPartControl2(Composite parent) {
		this.parent = parent;
		this.currentEntity = new ServerRegisterEntity(TABLE_ROW_ID_KEY);
