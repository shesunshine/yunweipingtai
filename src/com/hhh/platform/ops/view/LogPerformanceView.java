...
public class LogPerformanceView extends EntityViewPart {
	
	public static final String ID = "com.hhh.platform.ops.view.log.performance";

	private LogPerformanceEntity currentEntity;
	...
	public void createPartControl2(Composite parent) {
		this.parent = parent;
		this.currentEntity = new LogPerformanceEntity(TABLE_ROW_ID_KEY);
